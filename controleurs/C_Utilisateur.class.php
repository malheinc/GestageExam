...
class C_Utilisateur extends Controleur{
    ...
    //Validation de la création d'un 
    function validationcreerstage(){
        //$this->vue->titreVue = "Validation creation d'un stage";
        ...
        $lesParametres[0] = $_POST["choixEleve"];
        $lesParametres[1] = $_POST["choixEntreprise"];
        $lesParametres[2] = $_POST["choixMaitreStage"];
        $lesParametres[3] = DateToSql($_POST["dateDebut"]);
        $lesParametres[4] = DateToSql($_POST["dateFin"]);
        $lesParametres[5] = DateToSql($_POST["dateVisite"]);
        $lesParametres[6] = $_POST["villeStage"];
        $lesParametres[7] = $_POST["Divers"];
        $lesParametres[8] = $_POST["BilanTravaux"];
        $lesParametres[9] = $_POST["RessourcesOutils"];
        $lesParametres[10] = $_POST["Commentaires"];
        
        $ok=$Stages->insertStage($lesParametres);
        
//        if ($ok) {
//            $this->vue->message = "Stage ajouté.".$msg;
//        } else {
...
//        $this->vue->afficher();
    ...
    function afficheStage(){
        $this->vue->titreVue = 'Afficher un stage';   
        ...
        $this->vue->centre = "../vues/utilisateur/templates/centre.afficheStage.inc.php";
